  ...
  >
    ...
    <div class="mx-auto w-full max-w-7xl px-4">
      <div class="relative z-30 pt-32 text-center">
        ...
        >
          سیستم داشبوردی که شما را به گفتن
          <span
        ...
        >
          تایرو راه‌حل نهایی برای توسعه‌دهندگانی است که به دنبال ساخت داشبوردهای زیبای ناکست در کمترین زمان با استفاده از قدرت رابط کاربری شوریکن و تیلویند سی‌اس‌اس هستند.
        </BaseParagraph>
      ...
      >
        ...
        >
          <!-- Fake sidebar -->
          <div
            class="ltablet:w-16 ltablet:flex dark:bg-muted-800 absolute start-0 top-0 hidden h-full w-20 flex-col bg-white group-[&.scrolled]/landing:translate-x-0 group-[&.scrolled]/landing:opacity-100 group-[&:not(.scrolled)]/landing:opacity-0 motion-safe:transition-all motion-safe:duration-200 lg:flex ltr:group-[&:not(.scrolled)]/landing:-translate-x-full rtl:group-[&:not(.scrolled)]/landing:translate-x-full"
          >
            ...
            <div class="ltablet:gap-6 flex flex-col gap-6 sm:gap-3 lg:gap-4">
              ...
              >
                <DemoInboxMessage
                  ...
                  name="کندرا و."
                  title="پروژه طراحی"
                  text="در طراحی در چه مرحله‌ای هستیم؟ نیاز داریم تا صفحه‌های جدید را بررسی کنیم."
                  time="۲۸ دقیقه"
                  rounded="lg"
                />
              </BaseCard>
              ...
              >
                <DemoInfoBadges
                  ...
                  title="شما ۲ دستاورد جدید را باز کرده‌اید"
                  text="تبریک، تلاش‌های شما پاداش داده شده است. همینطور ادامه دهید!"
                />
              </BaseCard>
            </div>
            <!-- Col -->
            ...
            >
              ...
              >
                <DemoProgressCircle
                  ...
                  :title="`${y < 500 ? Math.trunc(y / 5) : 100}% کامل شده!`"
                  text="تبریک، تلاش‌های شما پاداش داده شده است. همینطور ادامه دهید!"
