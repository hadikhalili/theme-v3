    ...
    <div class="col-span-12">
      <div class="mx-auto flex size-full max-w-xl flex-col justify-center">
        <div class="text-center">
          ...
          >
            راه‌اندازی پیشرفته برنامه ناکست
          </BaseHeading>
          <BaseParagraph
            size="lg"
            class="text-muted-500 dark:text-muted-100 ptablet:max-w-lg ptablet:mx-auto mb-4 max-w-2xl"
          >
            تایرو یک اپلیکیشن قدرتمند شروع‌کننده ناکست است با یک پایگاه کد محکم و قابل گسترش. هر چیزی که برای ساختن یک فرانت‌اند حرفه‌ای و زیبا برای اپلیکیشن خود نیاز دارید را فراهم می‌کند.
          </BaseParagraph>
          <div
