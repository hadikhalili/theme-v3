  ...
  <div class="dark:bg-muted-900 bg-white py-24">
    <div class="mx-auto w-full max-w-7xl px-4">
      <div class="mb-16 max-w-2xl">
        ...
        >
          {{ demoPages.length }}+ دموی شگفت‌انگیز
        </BaseHeading>
        <BaseParagraph
          size="lg"
          class="text-muted-500 dark:text-muted-100 mx-auto mb-4"
        >
          تایرو با {{ demoPages.length }}+ صفحات از پیش‌ساخته شده، از جمله نمونه داشبورد و اپلیکیشن و همچنین مجموعه‌هایی مانند لیست‌ها، جداول، پروفایل‌ها و صفحات شخصی و بسیاری صفحات احراز هویت و ابزارهای دیگر ارائه می‌شود.
        </BaseParagraph>
      </div>
        ...
        <div class="ltablet:col-span-10 col-span-12 lg:col-span-10">
          ...
          <div v-if="props.cta" class="mt-24 flex items-center justify-center">
            <BaseButton
              ...
              to="/demos"
            >
              مشاهده تمامی {{ demoPages.length }} دموها
            </BaseButton>
          </div>
        </div>
      </div>
