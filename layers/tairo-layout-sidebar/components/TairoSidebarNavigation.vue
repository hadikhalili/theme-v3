...
<template>
  ...
  >
    <!-- Icon sidebar -->
    <div
      class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 pointer-events-auto relative z-20 flex h-full w-[80px] flex-col border-e bg-white transition-all duration-300"
      :class="
        isOpen
          ? ''
...
<style>
[dir='rtl'] [data-nui-tooltip][data-nui-tooltip-position^='end']::before,
[dir='rtl'] [data-nui-tooltip][data-nui-tooltip-position^='right']::before {
