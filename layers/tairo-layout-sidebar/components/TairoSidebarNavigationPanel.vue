...
<template>
  <div
    ...
    class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 pointer-events-auto relative z-10 h-full w-[220px] border-e bg-white transition-all duration-300"
    :class="
      isOpen
        ? ''
