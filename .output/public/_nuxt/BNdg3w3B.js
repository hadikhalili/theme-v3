const n=`<template>
  <div class="flex flex-wrap items-end gap-4">
    ...
    >
      <Icon name="ph:cookie-duotone" class="size-5" />
    </BaseIconBox>
    ...
    >
      <Icon name="ph:armchair-duotone" class="size-5" />
    </BaseIconBox>
    ...
    >
      <Icon name="ph:confetti-duotone" class="size-5" />
    </BaseIconBox>
    ...
    >
      <Icon name="ph:lamp-duotone" class="size-5" />
    </BaseIconBox>
    ...
    >
      <Icon name="ph:pill-duotone" class="size-5" />
    </BaseIconBox>
    ...
    >
      <Icon name="ph:medal-duotone" class="size-5" />
    </BaseIconBox>
    ...
    >
      <Icon name="ph:kanban-duotone" class="size-5" />
    </BaseIconBox>
    ...
    <BaseIconBox
      ...
      rounded="lg"
      color="none"
      class="bg-rose-100 text-rose-500 dark:border-2 dark:border-eose-500 dark:bg-rose-500/20 dark:text-rose-400"
    >
      <Icon name="ph:telegram-logo-duotone" class="size-5" />
    </BaseIconBox>
    ...
    <BaseIconBox
      ...
      rounded="lg"
      color="none"
      class="bg-red-100 text-red-500 dark:border-2 dark:border-eed-500 dark:bg-red-500/20 dark:text-red-400"
    >
      <Icon name="ph:fire-duotone" class="size-5" />
    </BaseIconBox>
    ...
    >
      <Icon name="ph:toggle-left-duotone" class="size-5" />
    </BaseIconBox>
  </div>
</template>
\`
