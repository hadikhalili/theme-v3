...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { rounded: "none" }, {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { rounded: "sm" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Icon, {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { rounded: "md" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Icon, {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { rounded: "lg" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Icon, {
  ...
  _push(ssrRenderComponent(_component_BaseButtonIcon, { rounded: "full" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Icon, {
