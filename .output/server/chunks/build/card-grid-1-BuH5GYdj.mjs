...
import { j as useRoute, u as useRouter, d as _sfc_main$D, l as _sfc_main$3, h as _sfc_main$u, _ as __nuxt_component_0$3, a as __nuxt_component_2, e as _sfc_main$e } from './server.mjs';
                ...
                _push2(ssrRenderComponent(_component_BaseCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="text-center leading-none sm:text-start"${_scopeId2}><h4 class="text-muted-800 dark:text-muted-100 font-sans text-base font-medium"${_scopeId2}>${ssrInterpolate(item.username)}</h4><p class="text-muted-400 font-sans text-sm"${_scopeId2}>${ssrInterpolate(item.position)}</p></div></div><div class="mt-4 flex items-center gap-3 sm:ms-auto sm:mt-0"${_scopeId2}><!--[-->`);
                      ...
                      _push3(`<!--]--></div></div><div class="flex flex-col items-center justify-between px-6 py-4 sm:flex-row"${_scopeId2}><div class="w-full grow space-y-1 sm:w-auto sm:max-w-[260px]"${_scopeId2}><div class="flex items-center justify-between"${_scopeId2}><h4 class="text-muted-700 dark:text-muted-100 font-sans text-sm font-medium"${_scopeId2}> \u067E\u06CC\u0634\u0631\u0641\u062A </h4><div${_scopeId2}><span class="text-muted-400 font-sans text-sm"${_scopeId2}>${ssrInterpolate(item.completed)}% </span></div></div>`);
                      ...
                      _push3(ssrRenderComponent(_component_BaseButton, { class: "w-full sm:w-auto" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(` \u0645\u0634\u0627\u0647\u062F\u0647 \u067E\u0631\u0648\u0641\u0627\u06CC\u0644 `);
                          } else {
                            return [
                              createTextVNode(" \u0645\u0634\u0627\u0647\u062F\u0647 \u067E\u0631\u0648\u0641\u0627\u06CC\u0644 ")
                            ];
                          }
                        }),
                        _: 2
