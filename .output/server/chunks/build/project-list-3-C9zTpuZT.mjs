...
import { j as useRoute, u as useRouter, d as _sfc_main$D, h as _sfc_main$u, a as __nuxt_component_2, l as _sfc_main$3, _ as __nuxt_component_0$3, b as _sfc_main$w, c as _sfc_main$v } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_BaseCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="grid grid-cols-4 p-4"${_scopeId2}><div class="relative flex flex-col text-center"${_scopeId2}><span class="text-muted-800 dark:text-muted-100 font-sans text-2xl font-bold"${_scopeId2}> 12 </span><p class="text-muted-400 font-sans text-xs"${_scopeId2}> \u062F\u0631 \u0645\u0633\u06CC\u0631 \u062F\u0631\u0633\u062A </p><span class="bg-primary-500 absolute end-0 top-0 size-2 rounded-full"${_scopeId2}></span></div><div class="relative flex flex-col text-center"${_scopeId2}><span class="text-muted-800 dark:text-muted-100 font-sans text-2xl font-bold"${_scopeId2}> 4 </span><p class="text-muted-400 font-sans text-xs"${_scopeId2}> \u06AF\u0630\u0634\u062A\u0647 </p><span class="absolute end-0 top-0 size-2 rounded-full bg-amber-500"${_scopeId2}></span></div><div class="relative flex flex-col text-center"${_scopeId2}><span class="text-muted-800 dark:text-muted-100 font-sans text-2xl font-bold"${_scopeId2}>${ssrInterpolate(unref(data)?.data.length || "0")}</span><p class="text-muted-400 font-sans text-xs"${_scopeId2}> \u0645\u062C\u0645\u0648\u0639 </p><span class="bg-success-500 absolute end-0 top-0 size-2 rounded-full"${_scopeId2}></span></div><div class="flex items-center justify-center"${_scopeId2}>`);
                  ...
                  return [
                    createVNode("div", { class: "grid grid-cols-4 p-4" }, [
                      createVNode("div", { class: "relative flex flex-col text-center" }, [
                        ...
                        createVNode("p", { class: "text-muted-400 font-sans text-xs" }, " \u062F\u0631 \u0645\u0633\u06CC\u0631 \u062F\u0631\u0633\u062A "),
                        createVNode("span", { class: "bg-primary-500 absolute end-0 top-0 size-2 rounded-full" })
                      ]),
                      createVNode("div", { class: "relative flex flex-col text-center" }, [
                        createVNode("span", { class: "text-muted-800 dark:text-muted-100 font-sans text-2xl font-bold" }, " 4 "),
                        createVNode("p", { class: "text-muted-400 font-sans text-xs" }, " \u06AF\u0630\u0634\u062A\u0647 "),
                        createVNode("span", { class: "absolute end-0 top-0 size-2 rounded-full bg-amber-500" })
                      ]),
                      createVNode("div", { class: "relative flex flex-col text-center" }, [
                        ...
                        createVNode("p", { class: "text-muted-400 font-sans text-xs" }, " \u0645\u062C\u0645\u0648\u0639 "),
                        createVNode("span", { class: "bg-success-500 absolute end-0 top-0 size-2 rounded-full" })
                      ]),
