                ...
                _push2(ssrRenderComponent(_component_BaseCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="leading-none"${_scopeId2}><h4 class="text-muted-800 dark:text-muted-100 font-sans text-sm font-medium"${_scopeId2}>${ssrInterpolate(item.owner.name)}</h4><p class="text-muted-400 font-sans text-xs"${_scopeId2}> \u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC \u0634\u062F\u0647 ${ssrInterpolate(item.updated)}</p></div><div class="ms-auto"${_scopeId2}>`);
                      ...
                      return [
                        createVNode("div", { class: "mb-3 flex items-center gap-3" }, [
                          ...
                          createVNode("div", { class: "leading-none" }, [
                            ...
                            createVNode("p", { class: "text-muted-400 font-sans text-xs" }, " \u0628\u0647\u200C\u0631\u0648\u0632\u0631\u0633\u0627\u0646\u06CC \u0634\u062F\u0647 " + toDisplayString(item.updated), 1)
                          ]),
