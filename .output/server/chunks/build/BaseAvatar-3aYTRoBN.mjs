...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="${ssrRenderClass([props.classes?.inner, "nui-avatar-inner"])}">`);
      ssrRenderSlot(_ctx.$slots, "default", {}, () => {
        ...
        if (props.src && props.srcDark) {
          _push(`<img${ssrRenderAttr("src", props.srcDark)} class="${ssrRenderClass([[unref(rounded) && radiuses[unref(rounded)], props.classes?.img], "nui-avatar-img hidden dark:block"])}">`);
        } else {
          _push(`<!---->`);
        }
        if (!props.src) {
      ...
      if ("badge" in _ctx.$slots || props.badgeSrc) {
        _push(`<div class="${ssrRenderClass([props.classes?.badge, "nui-avatar-badge"])}">`);
