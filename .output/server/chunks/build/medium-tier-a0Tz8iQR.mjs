    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_TairoModal, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex w-full items-center justify-between p-4 md:p-6"${_scopeId}><h3 class="font-heading text-muted-900 text-lg font-medium leading-6 dark:text-white"${_scopeId}> \u062F\u06CC\u0627\u0644\u0648\u06AF \u0628\u0632\u0631\u06AF </h3>`);
            ...
            return [
              createVNode("div", { class: "flex w-full items-center justify-between p-4 md:p-6" }, [
                createVNode("h3", { class: "font-heading text-muted-900 text-lg font-medium leading-6 dark:text-white" }, " \u062F\u06CC\u0627\u0644\u0648\u06AF \u0628\u0632\u0631\u06AF "),
      ...
      _push(ssrRenderComponent(_component_TairoModal, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex w-full items-center justify-between p-4 md:p-6"${_scopeId}><h3 class="font-heading text-muted-900 text-lg font-medium leading-6 dark:text-white"${_scopeId}> \u062F\u06CC\u0627\u0644\u0648\u06AF XL </h3>`);
            _push2(ssrRenderComponent(_component_BaseButtonClose, {
            ...
            return [
              createVNode("div", { class: "flex w-full items-center justify-between p-4 md:p-6" }, [
                createVNode("h3", { class: "font-heading text-muted-900 text-lg font-medium leading-6 dark:text-white" }, " \u062F\u06CC\u0627\u0644\u0648\u06AF XL "),
                createVNode(_component_BaseButtonClose, {
                  onClick: ($event) => isModalXlOpen.value = false
                }, null, 8, ["onClick"])
              ])
