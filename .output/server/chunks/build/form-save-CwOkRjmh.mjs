...
import { _ as _sfc_main$3 } from './TairoFormSave-DUdgzCNp.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_TairoFormGroup, {
        label: "\u06A9\u062C\u0627 \u0632\u0646\u062F\u06AF\u06CC \u0645\u06CC\u200C\u06A9\u0646\u06CC\u062F\u061F",
        sublabel: "\u0645\u06A9\u0627\u0646 \u062E\u0648\u062F \u0631\u0627 \u0628\u0647 \u0645\u0627 \u0627\u0637\u0644\u0627\u0639 \u062F\u0647\u06CC\u062F"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid grid-cols-12 gap-3"${_scopeId}><div class="col-span-12 sm:col-span-6"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_BaseSelect, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<option value=""${_scopeId2}> \u0627\u0646\u062A\u062E\u0627\u0628 \u06CC\u06A9 \u06A9\u0634\u0648\u0631 </option><option value="italy"${_scopeId2}> \u0627\u06CC\u0627\u0644\u0627\u062A \u0645\u062A\u062D\u062F\u0647 </option><option value="italy"${_scopeId2}> \u0627\u06CC\u062A\u0627\u0644\u06CC\u0627 </option><option value="france"${_scopeId2}> \u0641\u0631\u0627\u0646\u0633\u0647 </option><option value="spain"${_scopeId2}> \u0627\u0633\u067E\u0627\u0646\u06CC\u0627 </option><option value="germany"${_scopeId2}> \u0622\u0644\u0645\u0627\u0646 </option><option value="portugal"${_scopeId2}> \u0686\u06CC\u0646 </option>`);
                } else {
                  return [
                    createVNode("option", { value: "" }, " \u0627\u0646\u062A\u062E\u0627\u0628 \u06CC\u06A9 \u06A9\u0634\u0648\u0631 "),
                    createVNode("option", { value: "italy" }, " \u0627\u06CC\u0627\u0644\u0627\u062A \u0645\u062A\u062D\u062F\u0647 "),
                    createVNode("option", { value: "italy" }, " \u0627\u06CC\u062A\u0627\u0644\u06CC\u0627 "),
                    createVNode("option", { value: "france" }, " \u0641\u0631\u0627\u0646\u0633\u0647 "),
                    createVNode("option", { value: "spain" }, " \u0627\u0633\u067E\u0627\u0646\u06CC\u0627 "),
                    createVNode("option", { value: "germany" }, " \u0622\u0644\u0645\u0627\u0646 "),
                    createVNode("option", { value: "portugal" }, " \u0686\u06CC\u0646 ")
                  ];
                }
              }),
              _: 1
