                ...
                _push2(ssrRenderComponent(_component_BaseCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="flex items-center justify-between sm:justify-start"${_scopeId2}><div class="text-muted-400 mt-3 flex items-center gap-1 text-start text-sm sm:mt-0"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_Icon, {
                        name: "lucide:map-pin",
                        class: "size-3"
                      }, null, _parent3, _scopeId2));
                      _push3(`<span${_scopeId2}>${ssrInterpolate(item.location)}</span></div><div class="hidden px-2 sm:block"${_scopeId2}><span${_scopeId2}>\xB7</span></div><div class="text-muted-400 mt-3 flex items-center gap-1 text-start text-sm sm:mt-0"${_scopeId2}>`);
                      _push3(ssrRenderComponent(_component_Icon, {
                        name: "lucide:clock",
                        class: "size-3"
                      }, null, _parent3, _scopeId2));
