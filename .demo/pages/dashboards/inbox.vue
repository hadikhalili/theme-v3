...
const messages = [
  {
    ...
    abstract:
      'لورم ایپسوم متنی ساختگی است که توسط تایپوگراف‌ها و طراحان وب استفاده می‌شود.',
    content:
...
<template>
  ...
  >
    <!-- Sidebar -->
    <div
      class="border-muted-200 dark:border-muted-700/40 dark:bg-muted-800 flex w-20 flex-col items-center border-e bg-white"
    >
      <NuxtLink
        to="/dashboards"
    ...
    <ClientOnly>
      <Splitpanes ref="split" @resize="paneSize = $event[0].size">
        ...
        <Pane :size="100 - paneSize">
          <!-- Message details -->
          <div
            class="ltablet:static ltablet:grow border-muted-200 dark:border-muted-700/40 dark:bg-muted-800 fixed end-0 top-0 flex h-full flex-col border-s bg-white transition-transform duration-300 lg:static lg:grow"
            :class="
              panelActive
                ? 'translate-x-0'
            ...
            <div class="ltablet:max-w-5xl mx-auto w-full lg:max-w-5xl">
              ...
              >
                ...
                >
                  ...
                  <BaseHeading size="2xl" class="text-nowrap">
              ...
              >
                ...
                <div class="mt-24 grid grid-cols-1 gap-4 sm:grid-cols-4">
                  <button
                    ...
                    :key="index"
                    type="button"
                    class="hover:bg-muted-100/80 dark:hover:bg-muted-700/60 group flex items-center gap-3 rounded-xl p-2 text-start transition-colors duration-300"
                  >
                    <img
                      v-if="file.type === 'pdf'"
                      class="size-11"
