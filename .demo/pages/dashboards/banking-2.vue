    ...
    <div class="flex flex-col gap-6">
      ...
      >
        ...
        <div class="ltablet:w-2/5 w-full lg:w-2/5">
          <div
            class="ltablet:ps-12 ltablet:border-s border-muted-200 dark:border-muted-700 flex h-full flex-col lg:border-s lg:ps-12"
          >
      ...
      >
        <div
          class="ltablet:w-3/5 ltablet:border-e border-muted-300 dark:border-muted-700 w-full lg:w-3/5 lg:border-e"
        >
