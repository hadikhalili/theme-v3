            ...
            >
              ...
              <div class="mt-6 grow sm:mt-0">
                <div class="pb-4 text-center sm:pb-0 sm:text-start">
                  ...
                  >
                    <span>
                      آیا ایده‌ای برای مقاله جدید دارید؟ اگر نه، حتماً باید برای الهام گرفتن فید را بررسی کنید.
                    </span>
                  </BaseParagraph>
                  <div class="mt-2">
                    <BaseButton
            ...
            <NuxtLink to="#" class="flex flex-col">
              ...
              >
                <div class="mb-3">
                  ...
                  >
                    <span>یادگیری رمان مدرن</span>
                  </BaseHeading>
                  <BaseParagraph size="xs">
                    <span class="text-muted-400">
                      برخی محتوای مقاله و لورم ایپسوم دلور سیت امت به عنوان یک زیرعنوان ساختگی زیبا
                    </span>
                  </BaseParagraph>
                </div>
                <div class="flex gap-3">
                  ...
                  <div>
                    <BaseHeading
                      ...
                      class="text-muted-800 dark:text-white"
                    >
                      <span>مایک یانوفسکی</span>
                    </BaseHeading>
                    <BaseParagraph size="xs">
                      <span class="text-muted-400">نویسنده رمان</span>
                    </BaseParagraph>
                  </div>
                </div>
              </BaseCard>
              ...
              >
                <div class="mb-3">
                  <BaseHeading
                    ...
                    class="text-muted-800 mb-1 dark:text-white"
                  >
                    <span>۵ نکته نویسندگی مخصوص شما</span>
                  </BaseHeading>
                  <BaseParagraph size="xs">
                    <span class="text-muted-400">
                      برخی محتوای مقاله و لورم ایپسوم دلور سیت امت به عنوان یک زیرعنوان ساختگی زیبا
