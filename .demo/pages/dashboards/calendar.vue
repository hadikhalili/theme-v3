...
const formatter = (date) => {
  ...
  return `${dayName} ${dayNumber}` // Outputs: "Monday 27"
}
</script>
...
<template>
  ...
  >
    <!-- Sidebar -->
    <div
      class="border-muted-200 dark:border-muted-800/40 dark:bg-muted-800 fixed start-0 top-0 z-50 flex h-full w-20 flex-col items-center border-e bg-white lg:static"
    >
      <NuxtLink
        to="/dashboards"
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span>{{ capitalize(formatter(day)) }}</span>
          ...
          >
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="relative z-[5] grid grid-cols-4 gap-2 pt-4">
                ...
                <div data-nui-tooltip="شامل مستندات و مدارک">
                  <BaseCheckboxHeadless
                    v-model="selectedEventFeatures"
                    value="drive"
                    name="features"
                ...
                <div data-nui-tooltip="کاربران بیرونی">
                  <BaseCheckboxHeadless
                    v-model="selectedEventFeatures"
                    value="external"
                    name="features"
                ...
                <div data-nui-tooltip="اجازه ارسال دیدگاه">
                  <BaseCheckboxHeadless
                    v-model="selectedEventFeatures"
                    value="conversation"
                    name="features"
                ...
                <div class="p-4">
                  ...
                  <div class="mt-4 text-center">
                    <BaseHeading
                      ...
                      class="mb-1"
                    >
                      <span>هیچ رویداد در انتظاری وجود ندارد</span>
                    </BaseHeading>
                    <BaseParagraph
                      size="xs"
                      lead="tight"
                    ...
                    >
                      <span>تمام رویدادهای این هفته خود را برنامه‌ریزی کرده‌اید.</span>
                    </BaseParagraph>
                    <NuxtLink
                      href="#"
