        ...
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="p-4">
            ...
            >
              ...
              <span class="text-muted-400 text-xs">از ماه گذشته</span>
            </div>
          </BaseCard>
        </div>
        <!-- Stat tile -->
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="p-4">
            ...
            >
              ...
              <span class="text-muted-400 text-xs">در حال کاهش</span>
            </div>
          </BaseCard>
        </div>
        <!-- Stat tile -->
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="p-4">
            ...
            >
              <span>+4.5%</span>
              <Icon name="lucide:trending-up" class="size-5" />
              <span class="text-muted-400 text-xs">در حال افزایش</span>
            </div>
          </BaseCard>
        </div>
        <!-- Chart -->
        <div class="col-span-12 md:col-span-8">
          <BaseCard class="p-6">
            ...
            <div class="flex gap-8">
              <div>
                <span class="text-muted-400 font-sans text-xs">این ماه</span>
                <p class="text-primary-500 font-sans text-lg font-medium">
                  ۷۵۶۸۹۰ تومان
                </p>
              </div>
              <div>
                <span class="text-muted-400 font-sans text-xs">ماه گذشته</span>
                <p
            ...
            <AddonApexcharts v-bind="lineRevenue" class="ltr:-ms-4 rtl:-me-4" />
          </BaseCard>
        </div>
        <!-- Chart -->
        <div class="col-span-12 md:col-span-4">
          <BaseCard class="flex h-full flex-col p-6">
            ...
            <div class="mt-auto">
              ...
              >
                <div
                  class="border-muted-200 dark:border-muted-700 flex-1 border-e px-2"
                >
              ...
              <div class="flex justify-center gap-2">
                ...
                <div>
                  ...
                  <BaseParagraph size="xs">
                    <span class="text-muted-400">بهترین کانال فروش</span>
                  </BaseParagraph>
                </div>
              </div>
            </div>
