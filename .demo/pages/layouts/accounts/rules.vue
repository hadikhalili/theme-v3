        ...
        <div class="grid grid-cols-12 gap-8">
          ...
          <div class="col-span-7">
            <div class="flex size-full flex-col justify-center">
              ...
              >
                حسابی با تعادل هدف‌گذاری شده نگه‌دارید با انتقال وجوه به یا از
                پس‌انداز هر روز.
              </BaseParagraph>
            </div>
          </div>
          ...
          <div class="col-span-7">
            <div class="flex size-full flex-col justify-center">
              <BaseParagraph
                ...
                class="text-muted-500 dark:text-muted-500"
              >
                حساب را با موجودی ۰ تومان حفظ کنید با انتقال وجوه ورودی به پس‌انداز بعد از
                هر تراکنش.
              </BaseParagraph>
            </div>
          </div>
