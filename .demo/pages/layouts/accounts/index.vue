  ...
  <div class="w-full">
    ...
    <ul v-else class="max-w-2xl">
      ...
      <li>
        ...
        >
          <div class="w-3/5">
            <span class="font-heading text-muted-400 mb-1 text-xs">حساب کاربری</span>
          </div>
          <div class="w-1/5">
            <span class="font-heading text-muted-400 mb-1 text-xs">موجودی</span>
          </div>
        ...
        >
          ...
          <div class="w-2/5 md:w-1/5">
            <BaseText class="text-muted-800 dark:text-muted-200">
              {{ account.balance.toFixed(2) }} تومان
            </BaseText>
          </div>
          <div class="hidden md:block md:w-1/5">
            ...
            >
              ...
              <span class="font-heading text-sm">قانون جدید</span>
            </BaseButton>
          </div>
        </div>
      </li>
