...
<template>
  <div class="dark:bg-muted-900 min-h-screen bg-white">
    <DemoNavigationTop title="تنظیمات" close-to="/dashboards" />
      ...
      <div class="mx-auto w-full max-w-6xl px-4">
        <div class="grid w-full gap-8 md:grid-cols-12 md:gap-16">
          ...
          <div class="md:col-span-3 lg:col-span-3">
            <!--Tabs-->
            <div class="border-muted-200 dark:border-muted-800 h-full border-e">
              <ul class="xs:flex xs:gap-4 -me-0.5 font-sans">
                <li>
                  <NuxtLink
                    to="/layouts/settings"
                    class="font-heading xs:border-b-[3px] flex w-full cursor-pointer py-2 text-sm md:border-e-[3px]"
                    :class="
                      isPersonal
