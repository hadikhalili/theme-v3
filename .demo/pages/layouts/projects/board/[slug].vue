  ...
  >
    ...
    >
      ...
      <div class="flex items-center gap-2">
        ...
        <BaseButtonIcon rounded="full" data-nui-tooltip="تسک جدید">
          <Icon name="lucide:plus" class="size-4" />
        </BaseButtonIcon>
      </div>
    </div>
    <div class="flex h-[calc(100vh_-_133px)] grow space-x-6 space-x-reverse overflow-auto pt-2">
      <!-- Column -->
      <div
          ...
          >
            ...
            <div v-else>
              ...
              <div class="mt-2 text-center">
                ...
                >
                  <span>در حال حاضر هیچ کار در انتظاری برای نمایش وجود ندارد.</span>
                </BaseParagraph>
                <button
      ...
      <div class="flex w-72 shrink-0 flex-col">
        ...
        <div class="flex h-14 shrink-0 items-center px-2">
          <!-- Column title -->
          <span class="block font-sans text-sm font-semibold">سفارشی‌سازی</span>
        </div>
        <!-- Add button -->
        <div class="w-full">
          <button
          ...
          >
            ...
            <span class="text-sm">مدیریت ستون‌ها</span>
          </button>
        </div>
      </div>
