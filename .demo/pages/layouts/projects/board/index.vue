    ...
    <div v-if="!pending && data?.recent.length === 0">
      <div class="bg-muted-200 dark:bg-muted-800/60 rounded-xl p-6">
        ...
        <BaseParagraph size="sm" class="text-muted-400">
          به نظر می‌رسد هیچ پروژه‌ای برای مشاهده ندارید.
        </BaseParagraph>
      </div>
    </div>
      ...
      <div class="ltablet:col-span-5 col-span-12 mb-6 lg:col-span-5">
        ...
        >
          <div class="mb-8 max-w-sm">
            ...
            <BaseParagraph size="sm" class="text-muted-400">
              اینجا جدیدترین پروژه‌هایی است که در تیم شما مشاهده شده‌اند. برای جستجوی بیشتر، نام پروژه را در زیر وارد کنید.
            </BaseParagraph>
          </div>
          <BaseAutocomplete
            v-if="data?.data"
