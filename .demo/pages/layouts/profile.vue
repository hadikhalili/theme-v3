    ...
    <div v-else class="relative w-full">
      ...
      <div class="flex w-full flex-col">
        ...
        <div class="mx-auto w-full max-w-md text-center">
          ...
          <div
            class="divide-muted-200 dark:divide-muted-800 flex items-center justify-center divide-x rtl:divide-x-reverse"
          >
            <div class="text-muted-400 flex h-8 items-center gap-1 px-4">
              <Icon name="ph:circles-three-duotone" class="size-5" />
              <BaseText size="sm">
                {{ data?.personalInfo.relations }}+ روابط
              </BaseText>
            </div>
            <div
            ...
            >
              ...
              <BaseText size="sm">
                {{ data?.personalInfo.projects }} پروژه‌ها
              </BaseText>
            </div>
        ...
        <div class="col-span-12 sm:col-span-4">
          <div class="flex flex-col gap-6">
            ...
            <BaseCard class="p-8">
              ...
              <div>
                <BaseParagraph size="xs" class="text-muted-400">
                  این تنظیم را فعال یا غیرفعال کنید تا تعیین کنید که آیا شبکه شما هنگام تغییرات پروفایل باید مطلع شود یا نه.
                </BaseParagraph>
              </div>
            </BaseCard>
            <!-- Tools -->
