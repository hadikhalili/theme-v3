          ...
          <div class="me-auto ms-auto mt-4 w-full max-w-md">
            <div class="text-center">
              ...
              <BaseParagraph size="sm" class="text-muted-400 mb-6">
                دستورالعمل‌های ارسال شده به آدرس ایمیل خود را دنبال کنید
              </BaseParagraph>
            </div>
            <Transition
              mode="out-in"
              ...
              <div v-if="success" class="px-8 py-4">
                <div class="mb-4 space-y-4">
                  <BaseMessage class="p-6" :closable="false">
                    <p class="text-base">
                      ایمیلی برای شما ارسال شده است که شامل دستورالعمل‌هایی برای بازنشانی رمز عبور شما است.
                    </p>

                    <small class="block pt-2">
                      اگر ایمیلی دریافت نکردید، لطفاً پوشه هرزنامه خود را بررسی کنید. اگر همچنان ایمیلی دریافت نکردید، یعنی حساب کاربری ندارید
                    </small>
                  </BaseMessage>
                </div>
              </div>
