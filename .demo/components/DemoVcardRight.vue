  ...
  <div class="flex h-full flex-col">
    ...
    >
      <div class="flex-1">
        ...
        <BaseParagraph v-if="!props.centered" lead="none">
          <span class="text-primary-500 text-xs">دفتر مرکزی تایرو</span>
        </BaseParagraph>
        <BaseParagraph lead="none" :class="props.centered && 'text-center'">
          <span class="text-muted-400 text-xs">طراح رابط کاربری / تجربه کاربری</span>
        </BaseParagraph>
      </div>
    ...
    <div class="mb-4 space-y-2 font-sans">
      ...
      >
        ...
        <span class="text-muted-400 text-xs">لس‌آنجلس، کالیفرنیا</span>
      </div>
      <div
        class="flex items-end gap-2"
        :class="props.centered && 'justify-center'"
