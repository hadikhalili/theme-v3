  ...
  <div class="group relative">
    ...
    <div class="py-6">
      <div class="relative">
        ...
        >
        <div
          class="bg-primary-500/10 absolute start-1/2 top-1/2 size-20 -translate-y-1/2 rounded-full transition-transform duration-300 group-hover:scale-150 ltr:-translate-x-1/2 rtl:translate-x-1/2"
        />
      </div>
    </div>
