    ...
    <div class="w-full pe-1 [&>:not(:first-of-type):before]:mx-1">
      <div class="items-top flex w-full justify-between">
        <div>
          ...
          >
            {{ event.customData.title || 'رویداد جدید' }}
          </div>
          <div class="text-muted-400">
            {{ format(event.customData.startDate, 'HH:mm') }} تا {{ format(event.customData.endDate, 'HH:mm') }}
          </div>
        </div>
      ...
      >
        <div class="flex flex-wrap gap-2">
          ...
          <span
            ...
            class="text-muted-400"
            data-nui-tooltip="کاربران بیرونی"
          >
