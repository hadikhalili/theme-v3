        ...
        <div>
          <div class="mb-4 flex items-center justify-between">
            ...
            >
              ...
              />
              <span>تسک شماره {{ props.task?.id }}</span>
            </BaseTag>
          </div>
            ...
            <div v-if="props.task?.checklist.length === 0">
              ...
              <div class="mb-6 mt-2 text-center">
                <BaseHeading
                  ...
                  class="mb-1"
                >
                  <span>چیزی برای نمایش نیست</span>
                </BaseHeading>
                <BaseParagraph
                  size="xs"
                  lead="tight"
                ...
                >
                  <span>هیچ چک‌لیستی برای نمایش در اینجا در حال حاضر وجود ندارد.</span>
                </BaseParagraph>
              </div>
            </div>
          ...
          <div class="border-muted-200 dark:border-muted-700 border-b py-6">
            <h4 class="text-muted-400 font-sans text-xs font-semibold uppercase">
              فایل‌های پیوست شده ({{ props.task?.files.length }})
            </h4>
            <div v-if="props.task?.files.length === 0">
              ...
              <div class="mb-6 mt-2 text-center">
                ...
                <BaseParagraph
                  ...
                  class="text-muted-500 dark:text-muted-400 mx-auto max-w-[200px] !font-sans"
                >
                  <span>در حال حاضر هیچ فایلی برای نمایش در اینجا پیوست نشده است.</span>
                </BaseParagraph>
              </div>
            </div>
            <div v-else class="mt-6 space-y-4">
          ...
          <div class="py-6">
            <h4 class="text-muted-400 font-sans text-xs font-semibold uppercase">
              نظرات ({{ props.task?.comments.length }})
            </h4>
            <div v-if="props.task?.comments.length === 0">
              ...
              <div class="mb-6 mt-2 text-center">
                ...
                <BaseParagraph
                  ...
                  class="text-muted-500 dark:text-muted-400 mx-auto max-w-[200px] !font-sans"
                >
                  <span>در حال حاضر هیچ نظری برای نمایش در اینجا وجود ندارد.</span>
                </BaseParagraph>
              </div>
            </div>
              ...
              >
                ...
                <div>
                  ...
                  <BaseText
                    ...
                    lead="none"
                  >
                    منتشر شده توسط {{ comment.author.posted }}
                  </BaseText>
                  <BaseParagraph
                    size="xs"
