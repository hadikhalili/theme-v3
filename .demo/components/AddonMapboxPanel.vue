  ...
  features: [
    {
      ...
      properties: {
        ...
        description:
          'لورم ایپسوم متن ساختگی است. به یاد دارم که در آنجا بودم.',
      },
      geometry: {
        type: 'Point',
...
<template>
  <div class="relative">
    ...
    >
      <!-- Sidebar -->
      <div
        class="ltablet:h-screen ltablet:w-20 ltablet:border-e border-muted-200 dark:border-muted-700 dark:bg-muted-800 relative z-10 h-16 w-full bg-white lg:h-screen lg:w-20 lg:border-e"
      >
      ...
      >
        ...
        >
          <BaseHeading size="xl" weight="medium">
            <span class="text-muted-800 dark:text-white">موقعیت‌ها</span>
          </BaseHeading>
        ...
        >
          ...
          >
            <span class="text-muted-400">مکان‌های اخیر</span>
          </BaseHeading>
                  ...
                  <div class="mb-3 flex items-center gap-2">
                    ...
                    <div class="font-sans">
                      ...
                      <p class="text-muted-400 text-sm">
                        باز است تا {{ feature.properties.openingCount }}
                      </p>
                    </div>
                  </div>
                </div>
...
.mapboxgl-popup-close-button {
  right: unset;
  @apply h-6 w-6 flex items-center justify-center end-0;
}
