  ...
  <div class="group/password-strength relative">
    ...
    >
      <template #action>
        ...
        >
          <button
            class="leading-0 text-muted-400 peer-focus-within:text-primary-500 nui-focus absolute end-0 top-0 flex size-10 items-center justify-center text-center text-xl disabled:cursor-not-allowed"
            :class="buttonBorder"
            type="button"
            tabindex="0"
            :disabled="props.disabled"
            :data-nui-tooltip="props.disabled ? '' : `${
              showPassword ? 'عدم نمایش' : 'نمایش'
            } گذرواژه`"
