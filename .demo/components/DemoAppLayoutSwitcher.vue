      ...
      <div class="grid grid-cols-12 gap-6">
        ...
        >
          <div>
            ...
            <BaseParagraph size="sm" class="text-muted-400">
              چیدمانی را که می‌خواهید برای برنامه خود استفاده کنید انتخاب کنید
            </BaseParagraph>
          </div>
          <div
            ...
            >
              ...
              >
                <img
                  ...
                  class="mx-auto block max-w-[110px] transition-opacity duration-200 rtl:-scale-x-100 dark:hidden"
                  :class="
                ...
                <img
                  ...
                  class="mx-auto hidden max-w-[110px] transition-opacity duration-200 rtl:-scale-x-100 dark:block"
                  :class="
                    activeLayoutName === layout.name
                      ? 'opacity-100'
                      : 'opacity-60'
        ...
        >
          <div>
            ...
            <BaseParagraph size="sm" class="text-muted-400">
              تغییراتی در پالت رنگ ایجاد کنید
            </BaseParagraph>
          </div>
          <div class="space-y-1">
